...
class DefaultsService extends AbstractService
{
    ...
    {
        $repo = $this->getDoctrine()->getRepository('Entity:DefaultSurface');
    ...
    {
        $repo = $this->getDoctrine()->getRepository('Entity:DefaultRoof');
    ...
    {
        $repo = $this->getDoctrine()->getRepository('Entity:DefaultEnergy');
